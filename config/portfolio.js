const portfolio = {
  ...
  nautilus: {
    ...
    description:
      "Nautilus Labs allows maritime fleet operators to monitor and optimize shipping routes and fuel costs in real time.",
  },
  ...
  tortuga: {
    ...
    description:
      "Tortuga increases yields and profits for strawberry and soft fruit growers through higher density growing, more precise packing, and better supply forecasting.",
  },
  ...
  serve: {
    ...
    description:
      "Serve Automation is building fully automated food production systems.",
  },
  ...
  dusty: {
    ...
    description:
      "Dusty Robotics increases productivity, reduces cascading slippage, and reduces costly errors in complex construction projects.",
  },
  ...
  chargelab: {
    ...
    description:
      "ChargeLab provides API- and software-defined EV charging networks.",
  },
  ...
  plethora: {
    ...
    description:
      "Plethora is a manufacturing company that makes mechanical hardware iteration as efficient as software design iteration.",
  },
